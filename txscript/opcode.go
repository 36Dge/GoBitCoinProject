...
//an opcode defines the information related to a txscript opcode.opfucn,if
...
//these constants are the values of the official pocodes used on the btc wiki
//in bitcoin core and in most if not all other reference and software related
